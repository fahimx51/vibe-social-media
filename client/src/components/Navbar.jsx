...
export default function Navbar() {
    ...
    return (
        <div className='w-[90%] lg:w-[40%] h-[80px] bg-black/80 flex justify-around items-center fixed bottom-[20px] rounded-full shadow-xl shadow-[#000000]/70 z-[100]'>
            <div><GoHomeFill className='text-white w-[30px] h-[30px] cursor-pointer' /></div>
            <div><FiSearch className='text-white w-[30px] h-[30px] cursor-pointer' /></div>
            <div onClick={() => navigate('/loops')}><GoVideo className='text-white w-[30px] h-[30px] cursor-pointer' /></div>
            <div onClick={() => navigate('/upload')}><BsPlusSquare className='text-white w-[30px] h-[30px] cursor-pointer' /></div>
